-- xem index nào được sử dụng nhiều nhất
-- index nào ít sử dụng có thể xóa đi để tối ưu không gian lưu trữ
SELECT 
...
-- kiểm tra lại kích thước database sau khi xóa index thừa
SELECT pg_size_pretty(pg_database_size('pgrouting')) AS db_size;