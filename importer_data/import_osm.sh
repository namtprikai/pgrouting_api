...
psql -h db -p 5432 -U postgres -d pgrouting -c "CREATE EXTENSION IF NOT EXISTS postgis;"
psql -h db -p 5432 -U postgres -d pgrouting -c "CREATE EXTENSION IF NOT EXISTS pgrouting;"
